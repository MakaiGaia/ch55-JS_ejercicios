...
- `secretName(['Harry', 'Ron', 'Hermione'])` should return `'HHR'`. 
    1. Recibimos un array que tiene nombres
        1.1 Nombres empiezan en mayusculas
    ...
    4. Obtener la primera leta de cana nombre utilizando la notación de corchetes
...
const secretName = function(namesArray){
    ...
    sortedName.forEach((name) => societyName += name[0]);
    return societyName;
}
